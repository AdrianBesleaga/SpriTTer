        ...
        function() {
            ...
            $("#followButton")
                .click(
                    function() {
                        var userName = document
                            .getElementById('followButton').value;
                        var Data = {
                            "name": userName
                        };
            ...
            $("#messageButton")
                .click(
                    function() {
                        var textMessage = document
                            .getElementById('messageText').value;
                        var Data = {
                            "text": textMessage,
                            "user": "",
                            "date": ""
            ...
            $("#searchButton")
                .click(
                    function() {
                        var user = document
                            .getElementById('userNameSearch').value;
                        if (user.length > 1) {
                            window.location
                                .replace("http://localhost:8080/twitter/user/" + user);
                        }
                    });
